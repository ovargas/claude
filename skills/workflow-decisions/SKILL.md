...
description: Query project conventions and architectural decisions with source references. Use when the user explicitly requests the Virtual Team decisions workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: decisions

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/decisions.md) completely.
