...
description: Create a business proposal from an idea or feature breakdown. Use when the user explicitly requests the Virtual Team proposal workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: proposal

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/proposal.md) completely.
