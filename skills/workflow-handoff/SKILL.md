...
description: Capture session state for a clean transfer to another session. Use when the user explicitly requests the Virtual Team handoff workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: handoff

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/handoff.md) completely.
