...
description: Execute an approved technical plan with TDD and verification. Use when the user explicitly requests the Virtual Team implement workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: implement

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/implement.md) completely.
