...
description: Extract, define, and validate API contracts as concrete schema files. Use when the user explicitly requests the Virtual Team contracts workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: contracts

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/contracts.md) completely.
