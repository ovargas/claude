---
name: workflow-grill
description: Stress-test a feature specification or plan before implementation. Use when the user explicitly requests the Virtual Team grill workflow or when this workflow is the next stage of an active Virtual Team pipeline.
---

# Virtual Team: grill

1. Read [the Codex host adaptation guide](../codex-host-adaptation.md) completely.
2. Read [the canonical workflow](../../commands/grill.md) completely.
